# Generated by Django 3.1.7 on 2022-12-02 16:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment', to='ApiaApp.tbl_topics')),
            ],
        ),
    ]
